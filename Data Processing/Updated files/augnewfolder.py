...
image_base_path = fix_path('C:/Users/wezha/OneDrive/Desktop/tt100k_2021/tt100k_2021')
...
if annotations is None:
    ...
    for img_id, annotation in annotations.items():
        ...
        augmented_annotations[img_id] = {
            'path': output_img_path,
            'id': img_id,
            'objects': [{'bbox': {'xmin': obj['bbox']['xmin'], 'ymin': obj['bbox']['ymin'], 'xmax': obj['xmax'], 'ymax': obj['ymax']},
