    ...
    if len(images) >= 500:
        ...
        for start in range(0, augment_needed, batch_size):
            ...
            for i, aug_image in enumerate(aug_images):
                ...
                # Copy bounding boxes for the augmented images
                aug_annotation_objects = []
                for obj in annotations[images[i][0]]['objects']:
                    aug_annotation_objects.append({
                        'bbox': obj['bbox'],
                        'category': obj['category']
                    })
                ...
                annotations[aug_img_id] = {
                    ...
                    'id': aug_img_id,
                    'objects': aug_annotation_objects
                }
